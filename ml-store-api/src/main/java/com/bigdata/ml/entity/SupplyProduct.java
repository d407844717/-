...
public class SupplyProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SupplyProduct\",\"namespace\":\"com.bigdata.ml.entity\",\"fields\":[{\"name\":\"product_id\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"company_name\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"product_info\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"direction\",\"type\":\"string\",\"default\":\"null\"}]}");
   ...
   */
  public SupplyProduct(java.lang.CharSequence product_id, java.lang.CharSequence company_name, java.lang.CharSequence product_info, java.lang.CharSequence direction) {
  ...
  /** Creates a new SupplyProduct RecordBuilder */
  public static com.bigdata.ml.entity.SupplyProduct.Builder newBuilder() {
    return new com.bigdata.ml.entity.SupplyProduct.Builder();
  }
  
  /** Creates a new SupplyProduct RecordBuilder by copying an existing Builder */
  public static com.bigdata.ml.entity.SupplyProduct.Builder newBuilder(com.bigdata.ml.entity.SupplyProduct.Builder other) {
    return new com.bigdata.ml.entity.SupplyProduct.Builder(other);
  }
  
  /** Creates a new SupplyProduct RecordBuilder by copying an existing SupplyProduct instance */
  public static com.bigdata.ml.entity.SupplyProduct.Builder newBuilder(com.bigdata.ml.entity.SupplyProduct other) {
    return new com.bigdata.ml.entity.SupplyProduct.Builder(other);
  }
  
  /**
   * RecordBuilder for SupplyProduct instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SupplyProduct>
    implements org.apache.avro.data.RecordBuilder<SupplyProduct> {
    ...
    private Builder() {
      super(com.bigdata.ml.entity.SupplyProduct.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.bigdata.ml.entity.SupplyProduct.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing SupplyProduct instance */
    private Builder(com.bigdata.ml.entity.SupplyProduct other) {
            super(com.bigdata.ml.entity.SupplyProduct.SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'product_id' field */
    public com.bigdata.ml.entity.SupplyProduct.Builder setProductId(java.lang.CharSequence value) {
    ...
    public com.bigdata.ml.entity.SupplyProduct.Builder clearProductId() {
      product_id = null;
    ...
    /** Sets the value of the 'company_name' field */
    public com.bigdata.ml.entity.SupplyProduct.Builder setCompanyName(java.lang.CharSequence value) {
    ...
    public com.bigdata.ml.entity.SupplyProduct.Builder clearCompanyName() {
      company_name = null;
    ...
    /** Sets the value of the 'product_info' field */
    public com.bigdata.ml.entity.SupplyProduct.Builder setProductInfo(java.lang.CharSequence value) {
    ...
    public com.bigdata.ml.entity.SupplyProduct.Builder clearProductInfo() {
      product_info = null;
    ...
    /** Sets the value of the 'direction' field */
    public com.bigdata.ml.entity.SupplyProduct.Builder setDirection(java.lang.CharSequence value) {
    ...
    public com.bigdata.ml.entity.SupplyProduct.Builder clearDirection() {
      direction = null;
    ...
    @Override
    public SupplyProduct build() {
      try {
        SupplyProduct record = new SupplyProduct();
